...
8. '상품'이라 함은, '판매회원'이 '오픈마켓'을 통하여 판매하는 재화 및 용역 등 일체의 서비스를 말합니다. <br />
...
1. '회사'는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지, 전화번호, 모사전송번호(FAX), 전자우편주소, 사업자등록번호, 통신판매업신고번호 등을 '이용자'가 쉽게 알 수 있도록 '사이트'의 초기 서비스화면에 게시합니다. 다만, 본 약관의 내용은 '이용자'가 연결화면을 통하여 확인할 수 있도록 할 수 있습니다. <br />
...
4. '회사'가 본 약관을 개정하고자 할 경우, 적용일자 및 개정사유를 명시하여 현행약관과 함께 온라인 쇼핑몰의 초기화면에 그 적용일자 7일전부터 적용일자 전날까지 공지합니다. 다만, '이용자'에게 불리한 내용으로 약관을 변경하는 경우 최소 30일 이상 유예기간을 두고 공지합니다. <br />
5. '회사'가 본 약관을 개정한 경우, 개정약관은 적용일자 이후 체결되는 계약에만 적용되며 적용일자 이전 체결된 계약은 개정 전 약관이 적용됩니다. 다만, 이미 계약을 체결한 '이용자'가 개정약관의 내용을 적용받고자 하는 뜻을 '회사'에게 전달하고, '회사'가 여기에 동의한 경우 개정약관을 적용합니다. <br />
<br />
...
3. '회사'는 판매자가 등록한 상품 정보를 사전에 정한 기준과 방법에 따라 에 게재합니다. 이 때 '회사'는 게재하는 상품정보의 위치, 크기, 배열 등을 결정하고 조정할 수 있으며, 필요한 경우 상품정보 외의 사항을 함께 게재할 수 있습니다.<br />
<br />
...
1. '회사'는 계속적이고 안정적인 서비스의 제공을 위하여 설비에 장애가 생기거나 설비가 멸실된 때에는 이를 지체없이 수리 또는 복구하며, 다음 각호의 사유 발생 시 부득이한 경우 예고 없이 서비스의 전부 또는 일부의 제공을 일시 중지할 수 있습니다. 이 경우 그 사유 및 중지 기간 등을 지체 없이 '이용자'에게 공지합니다. <br />
...
2. 전항의 규정에도 불구하고 다음 각 호의 사유에 해당하는 경우, 배송받은 재화의 반품 또는 교환이 제한됩니다.  <br />
  가. '일반회원'에게 책임있는 사유로 상품이 멸실 또는 훼손된 경우(다만, 재화를 확인하기 위하여 포장 등을 훼손한 경우는 예외로 합니다) <br />
  나. '일반회원'의 사용 또는 소비에 의하여 재화의 가치가 현저히 감소한 경우 <br />
  다. 시간의 경과로 재판매가 곤란할 정도로 재화의 가치가 현저히 감소한 경우 <br />
  라. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본이 되는 재화의 포장을 훼손한 경우 <br />
  마. '일반회원'의 주문에 의하여 개별적으로 생산한 제품으로서 청약철회 및 교환의 제한에 대하여 사전에 고지한 경우 <br />
...
1. '일반회원'이 상품을 수령한 후 구매의사를 확정하면, 지체없이 '구매자 전용화면'에서 구매확정 의사를 표시(이하 '구매확정'이라 합니다)하여야 합니다. 다만, 수령 후 7일 이내에 '구매확정'하지 않는 경우 '회사'는 그 익일부터 '구매확정'으로 처리할 수 있습니다.  <br />
2. '구매확정'으로 처리되면 '회사'는 즉시 '판매회원'에게 대금을 지급하며, 이 후 발생하는 환불, 교환, 수리 등의 절차는 '일반회원'과 '판매회원'이 직접 해결하여야 합니다. <br />
...
2. '이용자'는 '쇼핑몰'에게 지식재산권이 있는 정보를 사전 승낙없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나, 제3자가 이용하게 하여서는 안됩니다. <br />
3. '이용자'가 서비스 내에 게시한 게시물, 이용후기 등 콘텐츠(이하 '콘텐츠')의 저작권은 해당 '콘텐츠'의 저작자에게 귀속됩니다.  <br />
4. 전항의 규정에도 불구하고 '회사'는 서비스의 운영, 전시, 전송, 배포, 홍보 등의 목적으로 별도의 허락 없이 무상으로 저작권법 및 공정한 거래관행에 합치되는 범위 내에서 다음 각호와 같이 '이용자'가 등록한 저작물을 이용할 수 있습니다. <br />
...
1. '회사'는 디지털 이용권 또는 Credit의 기간 만료와 관련하여 다음과 같은 시점에 사용자에게 이메일 알림을 제공합니다<br />
  가. 결제 시점<br />
...
- 수집정보: 포스터 제작 시 입력한 문구, 목적, 색상, 요소(인물, 사물 등)<br />
<br />
...
<br />
부칙<br />
제1조 본 방침은 2024.06.26.부터 시행됩니다.<br />
                </div>

                <div className="border-b-2"></div>
                <div className='text-xl mb-5 font-bold'>저작권 처리 방침</div>
                <div>
<strong>제1조(저작권 귀속)</strong><br />
사용자가 사이트에서 정당한 금액을 지불하고 구매한 이용권으로 생성한 AI 디지털 포스터 템플릿의 저작권은 사용자에게 귀속됩니다.<br />
<br />
<strong>제2조(상업적 이용 권한)</strong><br />
사용자는 AI 디지털 포스터 템플릿을 사이트에 저작물으로서 상업적으로 이용할 권리를 판매할 수 있습니다.<br />
<br />
<strong>제3조(수정 및 2차 저작물)</strong><br />
1. 구매회원은 구매한 AI 디지털 포스터 템플릿을 수정하여 상업적으로 이용할 수 있습니다.<br />
2. 하지만, 원본 템플릿의 저작권은 판매회원에게 있으므로 2차 저작물의 저작권을 판매할 수 없습니다.<br />
3. 수정된 2차 저작물의 상업적 이용은 허용된 원본 템플릿의 저작권을 침해하지 않는 범위 내에서 가능합니다.<br />
<br />
<strong>제4조(제한 사항)</strong><br />
1. 사용자는 AI 디지털 포스터 템플릿을 불법 복제, 배포하거나 저작권을 침해하는 행위를 해서는 안 됩니다.<br />
2. 저작권 침해로 인한 법적 책임은 전적으로 사용자가 부담합니다.<br />
<br />
<strong>제5조(저작권 보호)</strong><br />
